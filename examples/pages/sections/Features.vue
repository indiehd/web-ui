  ...
  <div class="cd-section" id="features">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4 class="description">Insight to help you create, connect, and convert. Understand Your Audience's
              Interests, Influence, Interactions, and Intent. Discover emerging topics and influencers to reach new
              audiences.</h4>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="info info-hover">
              ...
              <p class="description">Unify data from Facebook, Instagram, Twitter, LinkedIn, and Youtube to gain rich
                insights.</p>
            </div>
          </div>
          <div class="col-md-4">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-8 mr-auto ml-auto">
            ...
            <h4 class="description">Trello’s boards, lists, and cards enable you to organize and prioritize your
              projects in a fun, flexible and rewarding way.</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4 class="description">The CloudCheckr Cloud Management Platform (CMP) provides full visibility and control
              to reduce costs, improve cybersecurity posture, and automate critical tasks.</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <h4 class="description">Havenly is a convenient, personal and affordable way to redecorate your home room by
              room. Collaborate with our professional interior designers on our online platform. </h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-5">
            ...
            <div class="info info-horizontal">
              ...
              <div class="description">
                ...
                <p>The moment you use Now UI Kit, you know you’ve never felt anything like it. With a single use lets
                  you do more than ever before. </p>
              </div>
            </div>
            <div class="info info-horizontal">
              <div class="icon icon-primary icon-circle">
              ...
              <div class="description">
                ...
                <p>Divide details about your product or agency work into parts. Write a few lines about each one. A
                  paragraph describing a feature.</p>
              </div>
            </div>
            <div class="info info-horizontal">
              <div class="icon icon-primary icon-circle">
    ...
    <div class="features-6">
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">Working is a pleasure</h2>
            <h4 class="description">This is the paragraph where you can write more details about your product. Keep you
              user engaged by providing meaningful information.</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="info info-horizontal">
              ...
              <div class="description">
                ...
                <p>The moment you use Now UI Kit, you know you’ve never felt anything like it. With a single use, this
    ...
    <div class="features-7 section-image" style="background-image: url('img/bg11.jpg')">
      <div class="col-md-8 mr-auto ml-auto text-center">
        <h2 class="title">Working is a pleasure</h2>
        <h4 class="description">This is the paragraph where you can write more details about your product. Keep you user
          engaged by providing meaningful information.</h4>
      </div>
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 px-0">
            <div class="col-sm-12">
              <div class="info info-horizontal">
                ...
                <div class="description">
                  <h5 class="info-title">For Developers</h5>
                  <p class="description">The moment you use Now UI Kit, you know you’ve never felt anything like it.
                    With a single use, this powerfull UI Kit lets you do more than ever before. </p>
                </div>
              </div>
              <div class="info info-horizontal">
                <div class="icon">
    ...
    <div class="features-8 section-image" style="background-image: url('img/bg30.jpg')">
      <div class="col-md-8 ml-auto mr-auto text-center">
        <h2 class="title">Working is a pleasure</h2>
        <h4 class="description">Woodpecker.co is a follow-up automation SaaS founded in 2015. We’re an international
          team of 17, speaking 4 languages. Our mission is to enable all B2B companies to connect with their Ideal
          Customers.</h4>
      </div>
      <div class="container">
        <div class="row">
