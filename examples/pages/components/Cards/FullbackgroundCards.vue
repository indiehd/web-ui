<template>
  <div class="cards">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <card style="background-image: url('img/bg1.jpg')" type="background">
            ...
            <div class="card-footer text-left">
              ...
              <div class="stats-link pull-right">
                <a class="footer-link" href="#pablo">Environment</a>
              </div>
            </div>
          </card>
        </div>
        <div class="col-md-6">
          <card style="background-image: url('img/bg3.jpg')" type="background">
            <div class="card-title text-left">
              <h3>How wild Animals live in the National Forest</h3>
            </div>
            <div class="card-footer text-left">
