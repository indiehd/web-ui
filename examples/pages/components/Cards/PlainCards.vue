      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <card type="profile" plain>
            ...
            <div class="card-footer">
              <n-button type="primary" simple icon round><i class="fab fa-twitter"></i></n-button>
              <n-button type="primary" simple icon round><i class="fab fa-facebook-square"></i></n-button>
              <n-button type="primary" simple icon round><i class="fab fa-google"></i></n-button>
            </div>
          </card>
        </div>
      </div>
